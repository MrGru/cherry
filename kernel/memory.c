...
static struct mem_head blocks[32] = {
        {POOL_HEAD_INIT(blocks[0].head), LIST_HEAD_INIT(blocks[0].track.head)},
        {POOL_HEAD_INIT(blocks[1].head), LIST_HEAD_INIT(blocks[1].track.head)},
        {POOL_HEAD_INIT(blocks[2].head), LIST_HEAD_INIT(blocks[2].track.head)},
        {POOL_HEAD_INIT(blocks[3].head), LIST_HEAD_INIT(blocks[3].track.head)},
        {POOL_HEAD_INIT(blocks[4].head), LIST_HEAD_INIT(blocks[4].track.head)},
        {POOL_HEAD_INIT(blocks[5].head), LIST_HEAD_INIT(blocks[5].track.head)},
        {POOL_HEAD_INIT(blocks[6].head), LIST_HEAD_INIT(blocks[6].track.head)},
        {POOL_HEAD_INIT(blocks[7].head), LIST_HEAD_INIT(blocks[7].track.head)},
        {POOL_HEAD_INIT(blocks[8].head), LIST_HEAD_INIT(blocks[8].track.head)},
        {POOL_HEAD_INIT(blocks[9].head), LIST_HEAD_INIT(blocks[9].track.head)},
        {POOL_HEAD_INIT(blocks[10].head), LIST_HEAD_INIT(blocks[10].track.head)},
        {POOL_HEAD_INIT(blocks[11].head), LIST_HEAD_INIT(blocks[11].track.head)},
        {POOL_HEAD_INIT(blocks[12].head), LIST_HEAD_INIT(blocks[12].track.head)},
        {POOL_HEAD_INIT(blocks[13].head), LIST_HEAD_INIT(blocks[13].track.head)},
        {POOL_HEAD_INIT(blocks[14].head), LIST_HEAD_INIT(blocks[14].track.head)},
        {POOL_HEAD_INIT(blocks[15].head), LIST_HEAD_INIT(blocks[15].track.head)},
        {POOL_HEAD_INIT(blocks[16].head), LIST_HEAD_INIT(blocks[16].track.head)},
        {POOL_HEAD_INIT(blocks[17].head), LIST_HEAD_INIT(blocks[17].track.head)},
        {POOL_HEAD_INIT(blocks[18].head), LIST_HEAD_INIT(blocks[18].track.head)},
        {POOL_HEAD_INIT(blocks[19].head), LIST_HEAD_INIT(blocks[19].track.head)},
        {POOL_HEAD_INIT(blocks[20].head), LIST_HEAD_INIT(blocks[20].track.head)},
        {POOL_HEAD_INIT(blocks[21].head), LIST_HEAD_INIT(blocks[21].track.head)},
        {POOL_HEAD_INIT(blocks[22].head), LIST_HEAD_INIT(blocks[22].track.head)},
        {POOL_HEAD_INIT(blocks[23].head), LIST_HEAD_INIT(blocks[23].track.head)},
        {POOL_HEAD_INIT(blocks[24].head), LIST_HEAD_INIT(blocks[24].track.head)},
        {POOL_HEAD_INIT(blocks[25].head), LIST_HEAD_INIT(blocks[25].track.head)},
        {POOL_HEAD_INIT(blocks[26].head), LIST_HEAD_INIT(blocks[26].track.head)},
        {POOL_HEAD_INIT(blocks[27].head), LIST_HEAD_INIT(blocks[27].track.head)},
        {POOL_HEAD_INIT(blocks[28].head), LIST_HEAD_INIT(blocks[28].track.head)},
        {POOL_HEAD_INIT(blocks[29].head), LIST_HEAD_INIT(blocks[29].track.head)},
        {POOL_HEAD_INIT(blocks[30].head), LIST_HEAD_INIT(blocks[30].track.head)},
        {POOL_HEAD_INIT(blocks[31].head), LIST_HEAD_INIT(blocks[31].track.head)}
};
